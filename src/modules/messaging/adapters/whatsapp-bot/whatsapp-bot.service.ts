...
import { PresentQrCodeUseCase } from '../../../user/core/use-cases/present-qr-code.use-case';
import { WhatsappAudio } from '../../core/domain/whatsapp-audio.entity';
import { QrCode } from '../../../user/core/domain/qr-code.entity';
import type { CorrelationContextPort } from '../../../_shared/core/ports/correlation-context.port';
import { CORRELATION_CONTEXT_PORT } from '../../../_shared/core/ports/tokens';
