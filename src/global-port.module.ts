...
import { OpenaiLlmModule } from './modules/audio-processing/adapters/llm/openai/openai-llm.module';
...
@Global()
@Module({
    imports: [QueueModule, WhatsappBotModule, OpenaiLlmModule, LoggerProviderModule],
    providers: portProviders,
    exports: [...portProviders.map(p => p.provide), OpenaiLlmModule],
})
